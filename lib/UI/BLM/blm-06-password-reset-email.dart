                    ...
                    child: IntrinsicHeight(
                      child: Column(
                        children: [
                          ...
                          Center(child: const Text('Verify Email', style: const TextStyle(fontSize:42, fontFamily: 'NexaBold', color: const Color(0xff2F353D),),),),
                                ...
                                if(response.success){
                                  ...
                                  if(result == true){
                                    await showDialog(
                                      context: context,
                                      builder: (_) => AssetGiffyDialog(
                                        description: Text('An email has been sent to ${controller.text} containing instructions for resetting your password.', textAlign: TextAlign.center, style: TextStyle(fontSize: 24, fontFamily: 'NexaRegular'),),
