                    ...
                    children: [
                      ...
                      Padding(
                        padding: EdgeInsets.only(
                            left: SizeConfig.blockSizeHorizontal! * 11.25,
                            right: SizeConfig.blockSizeHorizontal! * 11.25),
                        child: Text(
                            ...
                            TextSpan(
                              ...
                              recognizer: TapGestureRecognizer()
                                ..onTap = () async {
                                  ...
                                  bool result =
                                      await apiBLMVerificationCodeResend();
                      ...
                      MiscBLMButtonTemplate(
                        ...
                        onPressed: () async {
                          if (controller.text.length != 3) {
                            ...
                            context.loaderOverlay.show();
                            String result = await apiBLMVerifyEmail(
