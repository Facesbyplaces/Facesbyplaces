                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          MiscBLMInputFieldTemplate(key: _key1, labelText: 'Your Name', type: TextInputType.name, labelTextStyle: const TextStyle(fontSize: 16, fontWeight: FontWeight.w400, color: const Color(0xff888888))),
                          
                          const SizedBox(height: 20,),
                          
                          MiscBLMInputFieldTemplate(key: _key2, labelText: 'Last Name', type: TextInputType.name, labelTextStyle: const TextStyle(fontSize: 16, fontWeight: FontWeight.w400, color: const Color(0xff888888))),

                          const SizedBox(height: 20,),

                          MiscBLMPhoneNumberTemplate(key: _key3, labelText: 'Mobile #', type: TextInputType.phone, labelTextStyle: const TextStyle(fontSize: 16, fontWeight: FontWeight.w400, color: const Color(0xff888888))),

                          const SizedBox(height: 20,),

                          MiscBLMInputFieldTemplate(key: _key4, labelText: 'Email Address', type: TextInputType.emailAddress, labelTextStyle: const TextStyle(fontSize: 16, fontWeight: FontWeight.w400, color: const Color(0xff888888))),

                          const SizedBox(height: 20,),

                          MiscBLMInputFieldTemplate(key: _key5, labelText: 'Username', type: TextInputType.text, labelTextStyle: const TextStyle(fontSize: 16, fontWeight: FontWeight.w400, color: const Color(0xff888888))),

                          const SizedBox(height: 20,),

                          MiscBLMInputFieldTemplate(key: _key6, labelText: 'Password', type: TextInputType.text, labelTextStyle: const TextStyle(fontSize: 16, fontWeight: FontWeight.w400, color: const Color(0xff888888)), obscureText: true,),
