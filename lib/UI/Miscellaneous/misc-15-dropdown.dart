...
class MiscDropDownTemplate extends StatefulWidget{

  @override
  MiscDropDownTemplateState createState() => MiscDropDownTemplateState();
}

class MiscDropDownTemplateState extends State<MiscDropDownTemplate>{
