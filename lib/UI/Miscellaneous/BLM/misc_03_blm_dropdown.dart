import 'package:facesbyplaces/API/BLM/15-Delete-Post/api_delete_post_blm_01_delete_post.dart';
...
class MiscBLMDropDownTemplate extends StatefulWidget{
  ...
  const MiscBLMDropDownTemplate({Key? key, required this.postId, required this.likePost, required this.likesCount, required this.reportType, required this.pageType, required this.pageName, required this.deletable}): super(key: key);
      ...
      child: BlocBuilder<BlocMiscBLMDropDown, String>(
        builder: (context, dropDownList) {
          return DropdownButton<String>(
            ...
            : <String>['Copy Link', 'Share', 'QR Code', 'Report'].map((String value) {
              return DropdownMenuItem<String>(
                value: value,
                child: Text(value),
              );
            ...
            onChanged: (String? listValue) async{
              ...
              if(dropDownList == 'Share'){
                ...
                String qrData = 'www.facesbyplaces.com/?q=Post-${widget.postId}-${widget.likePost == true ? 1 : 0}-${widget.likesCount}-${widget.pageType}'; // 'link-category' - 'post-id' - 'fase/true = 0/1' - 'number-of-likes' - 'account-type'
                ...
                if(confirmation){
                  ...
                  bool result = await apiBLMDeletePost(postId: widget.postId);
          ...
          return DropdownButton<String>(
            ...
            onChanged: (String? listValue) async{
              ...
              if(dropDownList == 'Share'){
                ...
                String qrData = 'www.facesbyplaces.com/?q=Memorial-${widget.memorialId}-${widget.pageType}'; // 'link-category' - 'link-type-of-account' - 'link-type-of-account'
