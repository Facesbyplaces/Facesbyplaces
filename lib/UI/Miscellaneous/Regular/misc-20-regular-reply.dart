...
class MiscRegularShowReply extends StatelessWidget{
  ...
  MiscRegularShowReply({this.image, this.firstName, this.lastName, this.commentBody, this.createdAt, this.numberOfLikes});
