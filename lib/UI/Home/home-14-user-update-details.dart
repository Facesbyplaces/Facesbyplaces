            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  MiscButtonTemplate(buttonText: 'Update', onPressed: (){Navigator.pushNamed(context, 'home/home-08-profile');}, width: SizeConfig.screenWidth / 2, height: SizeConfig.blockSizeVertical * 8, buttonColor: Color(0xff04ECFF),),
