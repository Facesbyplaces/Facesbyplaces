...
//         // _videoPlayerController = VlcPlayerController.file(videoFile.value, options: VlcPlayerOptions(video: VlcVideoOptions()));
//         _videoPlayerController = VlcPlayerController.file(videoFile.value, options: VlcPlayerOptions());
...
//         // _videoPlayerController = VlcPlayerController.file(file);
...
//                         Row(
//                           children: [
//                             const Text('Share your Memories', style: TextStyle(fontSize: 20, fontFamily: 'NexaRegular', color: Color(0xff000000),),),
...
//                                   isScrollable: true,
//                                   tabs: const [
//                                     Center(child: Text('Text', style: TextStyle(fontSize: 18, fontFamily: 'NexaRegular',),),),

//                                     Center(child: Text('Video', style: TextStyle(fontSize: 18, fontFamily: 'NexaRegular',),),),

//                                     Center(child: Text('Slide', style: TextStyle(fontSize: 18, fontFamily: 'NexaRegular',),),),
//                                   ],
//                                   onTap: (int number){
//                                     toggle.value = number;
//                                   },
...
//           // ),
//           ? VlcPlayer(
//             // controller: VlcPlayerController.file(file),
