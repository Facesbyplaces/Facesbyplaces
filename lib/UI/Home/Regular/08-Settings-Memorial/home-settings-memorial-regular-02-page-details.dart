...
class HomeRegularPageDetailsState extends State<HomeRegularPageDetails> {
  ...
  final GlobalKey<MiscRegularInputFieldDropDownState> _key2 =
      GlobalKey<MiscRegularInputFieldDropDownState>();
  final GlobalKey<MiscRegularInputFieldTemplateState> _key5 =
      GlobalKey<MiscRegularInputFieldTemplateState>();
  final GlobalKey<MiscRegularInputFieldTemplateState> _key6 =
      GlobalKey<MiscRegularInputFieldTemplateState>();
  ...
  Future<APIRegularShowPageDetailsMain> getMemorialSettings(
    ...
    controller1 = TextEditingController(
        text: newValue
            .almMemorial.showPageDetailsDetails.showPageDetailsDetailsDob);
    controller2 = TextEditingController(
        text: newValue
            .almMemorial.showPageDetailsDetails.showPageDetailsDetailsRip);
                        ...
                        children: [
                          MiscRegularInputFieldTemplate(
                            ...
                            displayText: memorialSettings
                                .data!.almMemorial.showPageDetailsName,
                          ...
                          MiscRegularInputFieldDropDown(
                            key: _key2,
                            displayText: memorialSettings
                                .data!.almMemorial.showPageDetailsRelationship,
                          ),
                          const SizedBox(
                            height: 20,
                          ),
                          ...
                          MiscRegularInputFieldTemplate(
                              ...
                              displayText: memorialSettings
                                  ...
                                  .almMemorial
                                  .showPageDetailsDetails
                                  .showPageDetailsDetailsCemetery,
                          labelTextStyle: TextStyle(
                            fontSize: SizeConfig.blockSizeVertical! * 2.11,
                            fontFamily: 'NexaRegular',
                            color: const Color(0xffBDC3C7),
                          ...
                          MiscRegularButtonTemplate(
                            ...
                            onPressed: () async {
                              if (memorialSettings.data!.almMemorial
                                          .showPageDetailsName !=
                                      _key1.currentState!.controller.text ||
                                  memorialSettings.data!.almMemorial
                                          .showPageDetailsRelationship !=
                                      _key2.currentState!.currentSelection ||
                                  memorialSettings
                                          .data!
                                          .almMemorial
                                          .showPageDetailsDetails
                                ...
                                if (confirmResult) {
                                  ...
                                  bool result =
                                      await apiRegularUpdatePageDetails(
