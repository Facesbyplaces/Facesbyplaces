...
class HomeRegularMemorialSettingsLocateMap extends StatefulWidget{
  const HomeRegularMemorialSettingsLocateMap({Key? key}) : super(key: key);

  @override
  HomeRegularMemorialSettingsLocateMapState createState() => HomeRegularMemorialSettingsLocateMapState();
}

class HomeRegularMemorialSettingsLocateMapState extends State<HomeRegularMemorialSettingsLocateMap>{
