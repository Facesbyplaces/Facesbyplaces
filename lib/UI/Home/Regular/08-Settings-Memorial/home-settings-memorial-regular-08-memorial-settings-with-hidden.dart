...
class HomeRegularMemorialSettingsWithHidden extends StatefulWidget {
  ...
  const HomeRegularMemorialSettingsWithHidden(
      {required this.memorialId, required this.relationship});

  HomeRegularMemorialSettingsWithHiddenState createState() =>
      HomeRegularMemorialSettingsWithHiddenState(
          memorialId: memorialId, relationship: relationship);
}

class HomeRegularMemorialSettingsWithHiddenState
    extends State<HomeRegularMemorialSettingsWithHidden> {
  final int memorialId;
  final String relationship;
  HomeRegularMemorialSettingsWithHiddenState(
      {required this.memorialId, required this.relationship});
        ...
        relationship != 'Friend'
            ? ListTile(
                onTap: () async {
                  ...
                  if (choice != '') {
                    bool result = await apiRegularMemorialSetRelationship(
                        memorialId: memorialId, relationship: choice);
                      ...
                      await showDialog(
                          ...
                          builder: (_) => AssetGiffyDialog(
                                ...
                                description: const Text(
                                  'Successfully updated the relationship setting.',
                                  textAlign: TextAlign.center,
                                ),
                                onlyOkButton: true,
                                onOkButtonPressed: () {
                ...
                subtitle: const Text(
                  'Set your relationship for this page',
                  style: const TextStyle(
                    fontWeight: FontWeight.w300,
                    color: const Color(0xffBDC3C7),
                  ),
            ...
            : ListTile(
                onTap: () async {
                  ...
                  if (confirmResult) {
                    ...
                    String result =
                        await apiRegularLeavePage(memorialId: memorialId);
