...
class HomeRegularPageFamilyState extends State<HomeRegularPageFamily>{
  Future<List<APIRegularShowFamilySettingsExtended>>? showListOfFamily;
  ...
  Future<List<APIRegularShowFamilySettingsExtended>> getListOfFamily({required int page}) async{
    APIRegularShowFamilySettingsMain? newValue;
    List<APIRegularShowFamilySettingsExtended> listOfFamily = [];

    do{
      newValue = await apiRegularShowFamilySettings(memorialId: widget.memorialId, page: page).onError((error, stackTrace){
        showDialog(
          context: context,
      ...
      listOfFamily.addAll(newValue.almFamilyList);
        ...
        builder: (_, bool loadedListener, __) => Scaffold(
          ...
          body: SafeArea(
            child: RefreshIndicator(
              onRefresh: onRefresh,
              child: FutureBuilder<List<APIRegularShowFamilySettingsExtended>>(
                            ...
                            trailing: MaterialButton(
                              ...
                              onPressed: () async{
                                ...
                                if(confirmation){
                                  ...
                                  String result = await apiRegularDeleteMemorialFriendsOrFamily(memorialId: widget.memorialId, userId: family.data![i].showFamilySettingsUser.showFamilySettingsDetailsId, accountType: family.data![i].showFamilySettingsUser.showFamilySettingsDetailsAccountType);
