...
//                                                   ),
//                                                   title: Text(page.showListOfManagedPagesName, overflow: TextOverflow.clip, style: const TextStyle(fontSize: 24, fontFamily: 'NexaBold', color: Color(0xff000000),),),
//                                                 ),
//                                                 // child: Row(
//                                                 //   children: [
//                                                 //     const SizedBox(width: 5,),

//                                                 //     page.showListOfManagedPagesProfileImage != ''
//                                                 //     ? CircleAvatar(
//                                                 //       backgroundColor: const Color(0xff888888),
//                                                 //       foregroundImage: NetworkImage(page.showListOfManagedPagesProfileImage),
//                                                 //       backgroundImage: const AssetImage('assets/icons/app-icon.png'),
...
//                                                 //     Text(page.showListOfManagedPagesName, overflow: TextOverflow.clip, style: const TextStyle(fontSize: 24, fontFamily: 'NexaBold', color: Color(0xff000000),),),
//                                                 //   ],
//                                                 // ),
//                                               );
//                                             }).toList(),
