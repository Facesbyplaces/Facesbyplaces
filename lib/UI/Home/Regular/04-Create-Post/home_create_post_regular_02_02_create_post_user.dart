...
import 'home_create_post_regular_01_create_post.dart';
                            ...
                            return ListView.separated(
                              ...
                              itemBuilder: (c, i){
                                return ListTile(
                                  ...
                                  onTap: (){
                                    Navigator.pop(context, RegularTaggedUsers(name: searchUsers.data![i].searchUsersFirstName + ' ' + searchUsers.data![i].searchUsersLastName, userId: searchUsers.data![i].searchUsersId, accountType: searchUsers.data![i].searchUsersAccountType),);
                                  },
                                );
                              },
                            );
