  ...
  void onLoading1() async {
    if (memorialFamilyItemsRemaining != 0) {
      ...
      memorialFamilyItemsRemaining = newValue
          .almFamilyMemorialList.memorialHomeTabMemorialFamilyItemsRemaining;
      count.value = count.value +
          newValue.almFamilyMemorialList.memorialHomeTabMemorialPage.length;

      for (int i = 0;
      i < newValue.almFamilyMemorialList.memorialHomeTabMemorialPage.length;
      i++) {
        finalMemorials.add(
          MiscRegularManageMemorialTab(
            index: i,
            memorialName: newValue.almFamilyMemorialList
                .memorialHomeTabMemorialPage[i].blmHomeTabMemorialPageName,
            description: newValue
                .almFamilyMemorialList
                .memorialHomeTabMemorialPage[i]
                .blmHomeTabMemorialPageDetails
                .blmHomeTabMemorialPageDetailsDescription,
            image: newValue.almFamilyMemorialList.memorialHomeTabMemorialPage[i]
                .blmHomeTabMemorialPageProfileImage,
            memorialId: newValue.almFamilyMemorialList
                .memorialHomeTabMemorialPage[i].blmHomeTabMemorialPageId,
            managed: newValue.almFamilyMemorialList
                .memorialHomeTabMemorialPage[i].blmHomeTabMemorialPageManage,
            follower: newValue.almFamilyMemorialList
                .memorialHomeTabMemorialPage[i].blmHomeTabMemorialPageFollower,
            famOrFriends: newValue
                .almFamilyMemorialList
                .memorialHomeTabMemorialPage[i]
                .blmHomeTabMemorialPageFamOrFriends,
            pageType: newValue.almFamilyMemorialList
    ...
    if (blmFamilyItemsRemaining != 0) {
      ...
      blmFamilyItemsRemaining =
          newValue.almFamilyMemorialList.blmHomeTabMemorialFamilyItemsRemaining;
      count.value = count.value +
          newValue.almFamilyMemorialList.blmHomeTabMemorialPage.length;

      for (int i = 0;
      i < newValue.almFamilyMemorialList.blmHomeTabMemorialPage.length;
      i++) {
        finalMemorials.add(
          MiscRegularManageMemorialTab(
            index: i,
            ...
            description: newValue
                ...
                .blmHomeTabMemorialPageDetails
                .blmHomeTabMemorialPageDetailsDescription,
            image: newValue.almFamilyMemorialList.blmHomeTabMemorialPage[i]
                .blmHomeTabMemorialPageProfileImage,
            memorialId: newValue.almFamilyMemorialList.blmHomeTabMemorialPage[i]
                .blmHomeTabMemorialPageId,
            managed: newValue.almFamilyMemorialList.blmHomeTabMemorialPage[i]
                .blmHomeTabMemorialPageManage,
            follower: newValue.almFamilyMemorialList.blmHomeTabMemorialPage[i]
                .blmHomeTabMemorialPageFollower,
            famOrFriends: newValue.almFamilyMemorialList
                .blmHomeTabMemorialPage[i].blmHomeTabMemorialPageFamOrFriends,
            pageType: newValue.almFamilyMemorialList.blmHomeTabMemorialPage[i]
                .blmHomeTabMemorialPagePageType,
            relationship: newValue.almFamilyMemorialList
  ...
  void onLoading2() async {
    if (memorialFriendsItemsRemaining != 0) {
      ...
      memorialFriendsItemsRemaining = newValue
          .almFriendsMemorialList.memorialHomeTabMemorialFriendsItemsRemaining;
      count.value = count.value +
          newValue.almFriendsMemorialList.memorialHomeTabMemorialPage.length;

      for (int i = 0;
      i <
          newValue
              .almFriendsMemorialList.memorialHomeTabMemorialPage.length;
      i++) {
        finalMemorials.add(
          MiscRegularManageMemorialTab(
            index: i,
            memorialName: newValue.almFriendsMemorialList
                .memorialHomeTabMemorialPage[i].blmHomeTabMemorialPageName,
            description: newValue
                .almFriendsMemorialList
                .memorialHomeTabMemorialPage[i]
                .blmHomeTabMemorialPageDetails
                .blmHomeTabMemorialPageDetailsDescription,
            image: newValue
                ...
                .memorialHomeTabMemorialPage[i]
                .blmHomeTabMemorialPageProfileImage,
            memorialId: newValue.almFriendsMemorialList
                .memorialHomeTabMemorialPage[i].blmHomeTabMemorialPageId,
            managed: newValue.almFriendsMemorialList
                .memorialHomeTabMemorialPage[i].blmHomeTabMemorialPageManage,
            follower: newValue.almFriendsMemorialList
                .memorialHomeTabMemorialPage[i].blmHomeTabMemorialPageFollower,
            famOrFriends: newValue
                .almFriendsMemorialList
                .memorialHomeTabMemorialPage[i]
                .blmHomeTabMemorialPageFamOrFriends,
            pageType: newValue.almFriendsMemorialList
                .memorialHomeTabMemorialPage[i].blmHomeTabMemorialPagePageType,
            relationship: newValue
                .almFriendsMemorialList
                .memorialHomeTabMemorialPage[i]
    ...
    if (blmFriendsItemsRemaining != 0) {
      ...
      blmFriendsItemsRemaining = newValue
          .almFriendsMemorialList.blmHomeTabMemorialFriendsItemsRemaining;
      count.value = count.value +
          newValue.almFriendsMemorialList.blmHomeTabMemorialPage.length;

      for (int i = 0;
      i < newValue.almFriendsMemorialList.blmHomeTabMemorialPage.length;
      i++) {
        finalMemorials.add(
          MiscRegularManageMemorialTab(
            index: i,
            ...
            description: newValue
                ...
                .blmHomeTabMemorialPageDetails
                .blmHomeTabMemorialPageDetailsDescription,
            image: newValue.almFriendsMemorialList.blmHomeTabMemorialPage[i]
                .blmHomeTabMemorialPageProfileImage,
            memorialId: newValue.almFriendsMemorialList
                .blmHomeTabMemorialPage[i].blmHomeTabMemorialPageId,
            managed: newValue.almFriendsMemorialList.blmHomeTabMemorialPage[i]
                .blmHomeTabMemorialPageManage,
            follower: newValue.almFriendsMemorialList.blmHomeTabMemorialPage[i]
                .blmHomeTabMemorialPageFollower,
            famOrFriends: newValue.almFriendsMemorialList
                .blmHomeTabMemorialPage[i].blmHomeTabMemorialPageFamOrFriends,
            pageType: newValue.almFriendsMemorialList.blmHomeTabMemorialPage[i]
                .blmHomeTabMemorialPagePageType,
            relationship: newValue.almFriendsMemorialList
                .blmHomeTabMemorialPage[i].blmHomeTabMemorialPageRelationship,
          ),
        );
      }
