...
class HomeRegularFeedTabState extends State<HomeRegularFeedTab> {
  ...
  ValueNotifier<List<RegularMainPagesFeeds>> feeds =
      ValueNotifier<List<RegularMainPagesFeeds>>([]);
  ...
  void onLoading() async {
    if (itemRemaining != 0) {
      ...
      for (int i = 0; i < newValue.almFamilyMemorialList.length; i++) {
        ...
        List<int> newList4 = [];
        for (int j = 0;
            j < newValue.almFamilyMemorialList[i].homeTabFeedPostTagged.length;
            j++) {
        ...
        feeds.value.add(
          RegularMainPagesFeeds(
            userId: newValue.almFamilyMemorialList[i].homeTabFeedPage
                .homeTabFeedPagePageCreator.homeTabFeedPageCreatorId,
            postId: newValue.almFamilyMemorialList[i].homeTabFeedId,
            memorialId: newValue
                .almFamilyMemorialList[i].homeTabFeedPage.homeTabFeedPageId,
            timeCreated: newValue.almFamilyMemorialList[i].homeTabFeedCreatedAt,
            memorialName: newValue
                .almFamilyMemorialList[i].homeTabFeedPage.homeTabFeedPageName,
            postBody: newValue.almFamilyMemorialList[i].homeTabFeedBody,
            profileImage: newValue.almFamilyMemorialList[i].homeTabFeedPage
                .homeTabFeedPageProfileImage,
            imagesOrVideos:
                newValue.almFamilyMemorialList[i].homeTabFeedImagesOrVideos,
            managed: newValue
                .almFamilyMemorialList[i].homeTabFeedPage.homeTabFeedPageManage,
            joined: newValue.almFamilyMemorialList[i].homeTabFeedPage
                .homeTabFeedPageFollower,
            numberOfComments:
                newValue.almFamilyMemorialList[i].homeTabFeedNumberOfComments,
            numberOfLikes:
                newValue.almFamilyMemorialList[i].homeTabFeedNumberOfLikes,
            likeStatus: newValue.almFamilyMemorialList[i].homeTabFeedLikeStatus,
            numberOfTagged:
                newValue.almFamilyMemorialList[i].homeTabFeedPostTagged.length,
            taggedFirstName: newList1,
            taggedLastName: newList2,
            taggedImage: newList3,
            taggedId: newList4,
            pageType: newValue.almFamilyMemorialList[i].homeTabFeedPage
                .homeTabFeedPagePageType,
            famOrFriends: newValue.almFamilyMemorialList[i].homeTabFeedPage
                .homeTabFeedPageFamOrFriends,
            relationship: newValue.almFamilyMemorialList[i].homeTabFeedPage
  ...
  Widget build(BuildContext context) {
    ...
    return ValueListenableBuilder(
      ...
      builder: (_, bool isGuestLoggedInListener, __) => ValueListenableBuilder(
        ...
        builder: (_, List<RegularMainPagesFeeds> feedsListener, __) =>
                    ...
                    children: [
                      ...
                      isGuestLoggedInListener
                          ...
                          : MiscRegularButtonTemplate(
                              ...
                              onPressed: () {
                                Navigator.pushNamed(
                                    context, '/home/regular/create-memorial');
                              },
