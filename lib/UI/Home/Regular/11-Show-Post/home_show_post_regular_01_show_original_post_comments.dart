...
//       print('The length of commentsLikes ${commentsLikes.length}');
//       print('The length of commentsNumberOfLikes ${commentsNumberOfLikes.length}');
//     }
...
//                                                                             if(listOfReplyLikeStatus.hasData){
//                                                                               return Align(
//                                                                                 alignment: Alignment.centerRight,
//                                                                                 child: TextButton.icon(
//                                                                                   onPressed: () async{
