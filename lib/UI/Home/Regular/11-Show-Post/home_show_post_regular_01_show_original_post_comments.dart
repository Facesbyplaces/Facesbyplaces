...
//   Future<APIRegularShowListOfCommentsDuplicate> getListOfComments() async{
//     APIRegularShowListOfCommentsDuplicate newValue = await apiRegularShowListOfCommentsDuplicate(postId: widget.postId,);

//     for(int i = 0; i < newValue.almCommentsList.length; i++){
//       APIRegularShowCommentOrReplyLikeStatus commentLikeStatus = await apiRegularShowCommentOrReplyLikeStatus(commentableType: 'Comment', commentableId: newValue.almCommentsList[i].showListOfCommentsCommentId);
...
//   Future<APIRegularShowListOfRepliesDuplicate> getListOfReplies({required int commentId}) async{
//     APIRegularShowListOfRepliesDuplicate newValue = await apiRegularShowListOfRepliesDuplicate(postId: commentId);

//     for(int i = 0; i < newValue.almRepliesList.length; i++){
//       APIRegularShowCommentOrReplyLikeStatus commentLikeStatus = await apiRegularShowCommentOrReplyLikeStatus(commentableType: 'Reply', commentableId: newValue.almRepliesList[i].showListOfRepliesCommentId);
...
//                                                                 isReply: true, 
//                                                                 toReply: listOfComments.data!.almCommentsList[i].showListOfCommentsCommentBody, 
//                                                                 replyFrom: '${listOfComments.data!.almCommentsList[i].showListOfCommentsUser.showListOfCommentsUserFirstName}' '${listOfComments.data!.almCommentsList[i].showListOfCommentsUser.showListOfCommentsUserLastName}',
//                                                                 currentCommentId: listOfComments.data!.almCommentsList[i].showListOfCommentsCommentId,
//                                                               ),);
//                                                             },
//                                                           ),
//                                                         ],
...
//                                                       FutureBuilder<APIRegularShowListOfRepliesDuplicate>(
...
//                                                                   children: [
//                                                                     Expanded(
//                                                                       child: currentUserId == listOfReplies.data!.almRepliesList[index].showListOfRepliesUser.showListRepliesUserUserId && currentAccountType == listOfReplies.data!.almRepliesList[index].showListOfRepliesUser.showListRepliesUserAccountType
//                                                                       ? const Text('You', style: TextStyle(fontSize: 20, fontFamily: 'NexaBold', color: Color(0xff000000),),)
...
//                                                                             controller.text = listOfReplies.data!.almRepliesList[index].showListOfRepliesUser.showListRepliesUserFirstName + ' ' + listOfReplies.data!.almRepliesList[index].showListOfRepliesUser.showListRepliesUserLastName + ' ';

//                                                                             await showModalBottomSheet(context: context, builder: (context) => showKeyboard(
//                                                                               isReply: true, 
//                                                                               toReply: listOfReplies.data!.almRepliesList[index].showListOfRepliesReplyBody, 
//                                                                               replyFrom: '${listOfReplies.data!.almRepliesList[index].showListOfRepliesUser.showListRepliesUserFirstName} ${listOfReplies.data!.almRepliesList[index].showListOfRepliesUser.showListRepliesUserLastName}',
//                                                                               currentCommentId: listOfReplies.data!.almRepliesList[index].showListOfRepliesCommentId,
//                                                                             ));
//                                                                           },
//                                                                         ),
//                                                                       ],
...
//                                                                 ),
//                                                                 onTap: (){
//                                                                   Navigator.push(context, MaterialPageRoute(builder: (context) => HomeRegularUserProfile(userId: listOfReplies.data!.almRepliesList[index].showListOfRepliesUser.showListRepliesUserUserId, accountType: listOfReplies.data!.almRepliesList[index].showListOfRepliesUser.showListRepliesUserAccountType,),),);
//                                                                 },
//                                                                 onLongPress: () async{
//                                                                   if(currentUserId == listOfReplies.data!.almRepliesList[index].showListOfRepliesUser.showListRepliesUserUserId && currentAccountType == listOfReplies.data!.almRepliesList[index].showListOfRepliesUser.showListRepliesUserAccountType){
...
//                                                                               onTap: () async{
//                                                                                 controller.text = controller.text + listOfReplies.data!.almRepliesList[index].showListOfRepliesReplyBody;
//                                                                                 await showModalBottomSheet(
//                                                                                   context: context,
//                                                                                   builder: (context) => showKeyboardEdit(isEdit: false, editId: listOfReplies.data!.almRepliesList[index].showListOfRepliesReplyId),
//                                                                                 );
//                                                                               },
//                                                                             ),
//                                                                             ListTile(
...
//                                                                                 await apiRegularDeleteReply(replyId: listOfReplies.data!.almRepliesList[index].showListOfRepliesReplyId);
//                                                                                 controller.clear();
//                                                                                 onRefresh();
...
//                                                   ),
//                                                   onTap: (){
//                                                     Navigator.push(context, MaterialPageRoute(builder: (context) => HomeRegularUserProfile(userId: listOfComments.data!.almCommentsList[i].showListOfCommentsUser.showListOfCommentsUserId, accountType: listOfComments.data!.almCommentsList[i].showListOfCommentsUser.showListOfCommentsUserAccountType,)));
//                                                   },
//                                                   onLongPress: () async{
//                                                     if(currentUserId == listOfComments.data!.almCommentsList[i].showListOfCommentsUser.showListOfCommentsUserId && currentAccountType == listOfComments.data!.almCommentsList[i].showListOfCommentsUser.showListOfCommentsUserAccountType){
//                                                       await showMaterialModalBottomSheet(
//                                                         context: context,
//                                                         builder: (context) => SafeArea(
//                                                           top: false,
...
//                                                                 leading: const Icon(Icons.edit),
//                                                                 onTap: () async {
//                                                                   controller.text = controller.text + listOfComments.data!.almCommentsList[i].showListOfCommentsCommentBody;
//                                                                   await showModalBottomSheet(
//                                                                     context: context,
//                                                                     builder: (context) => showKeyboardEdit(isEdit: true, editId: listOfComments.data!.almCommentsList[i].showListOfCommentsCommentId),
//                                                                   );
//                                                                 },
//                                                               ),
...
//                                                                 onTap: () async{
//                                                                   context.loaderOverlay.show();
//                                                                   await apiRegularDeleteComment(commentId: listOfComments.data!.almCommentsList[i].showListOfCommentsCommentId);
//                                                                   controller.clear();
//                                                                   onRefresh();
//                                                                   context.loaderOverlay.hide();
//                                                                   Navigator.pop(context);
...
class HomeRegularShowOriginalPostCommentsState extends State<HomeRegularShowOriginalPostComments>{
  ...
  Future<List<APIRegularShowListOfCommentsExtended>> getListOfComments({required int page}) async{
    ...
    for(int i = 0; i < listOfComments.length; i++){
      APIRegularShowCommentOrReplyLikeStatus commentLikeStatus = await apiRegularShowCommentOrReplyLikeStatus(commentableType: 'Comment', commentableId: listOfComments[i].showListOfCommentsCommentId);
      commentsNumberOfLikes.add(commentLikeStatus.showCommentOrReplyNumberOfLikes);
      commentsLikes.add(commentLikeStatus.showCommentOrReplyLikeStatus);
    }
  ...
  Future<List<APIRegularShowListOfRepliesExtended>> getListOfReplies({required int commentId, required int page}) async{
    ...
    for(int i = 0; i < listOfReplies.length; i++){
      APIRegularShowCommentOrReplyLikeStatus replyLikeStatus = await apiRegularShowCommentOrReplyLikeStatus(commentableType: 'Reply', commentableId: listOfReplies[i].showListOfRepliesCommentId);
      repliesNumberOfLikes.add(replyLikeStatus.showCommentOrReplyNumberOfLikes);
      repliesLikes.add(replyLikeStatus.showCommentOrReplyLikeStatus);
    }
                                                  ...
                                                  title: Row(
                                                    children: [
                                                      ...
                                                      Expanded(
                                                        child: Align(
                                                          alignment: Alignment.centerRight,
                                                          child: MiscLikeButtonTemplate(likeStatus: commentsLikes[i], numberOfLikes: commentsNumberOfLikes[i], commentableType: 'Comment', commentableId: listOfComments.data![i].showListOfCommentsCommentId),
                                                        )
                                                      ),
                                                    ],
                                                  ),
                                                                ...
                                                                title: Row(
                                                                  children: [
                                                                    ...
                                                                    Expanded(
                                                                      child: Align(
                                                                        alignment: Alignment.centerRight,
                                                                        child: MiscLikeButtonTemplate(likeStatus: repliesLikes[index], numberOfLikes: repliesNumberOfLikes[index], commentableType: 'Reply', commentableId: listOfReplies.data![index].showListOfRepliesReplyId),
                                                                      ),
                                                                    ),
                                                                  ],
                                                                ),
