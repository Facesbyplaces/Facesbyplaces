...
class HomeRegularShowOriginalPostCommentsState extends State<HomeRegularShowOriginalPostComments>{
  ...
  Future<APIRegularShowListOfComments> getListOfComments() async{
    ...
    while(commentsRemaining != 0){
      ...
      page1++;
      commentsRemaining = newValue.almItemsRemaining;
                                ...
                                return CustomScrollView(
                                  ...
                                  slivers: <Widget>[
                                    ...
                                    SliverToBoxAdapter( // COMMENTS AND REPLIES
                                      ...
                                      ? FutureBuilder<APIRegularShowListOfComments>(
                                                        ...
                                                        if(listOfReplies.connectionState != ConnectionState.done){
                                                          ...
                                                          return Column(
                                                            children: List.generate(listOfReplies.data!.almRepliesList.length, (index) => ListTile(
                                                              ...
                                                              onTap: (){
                                                                Navigator.push(context, MaterialPageRoute(builder: (context) => HomeRegularUserProfile(userId: listOfReplies.data!.almRepliesList[index].showListOfRepliesUser.showListRepliesUserUserId, accountType: listOfReplies.data!.almRepliesList[index].showListOfRepliesUser.showListOfCommentsUserAccountType,),),);
                                                              },
                                                              onLongPress: () async{
                                                                if(currentUserId == listOfReplies.data!.almRepliesList[index].showListOfRepliesUser.showListRepliesUserUserId && currentAccountType == listOfReplies.data!.almRepliesList[index].showListOfRepliesUser.showListOfCommentsUserAccountType){
