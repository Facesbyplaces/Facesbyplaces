...
class HomeRegularShowOriginalPostCommentsState extends State<HomeRegularShowOriginalPostComments>{
  ...
  ValueNotifier<bool> deletable = ValueNotifier<bool>(false);
  ...
  Future<APIRegularShowOriginalPostMain> getOriginalPost(postId) async{
    ...
    deletable.value = newValue.almPost.showOriginalPostDeletable;
    return newValue;
  }
          ...
          builder: (_, bool isGuestLoggedInListener, __) => ValueListenableBuilder(
            ...
            builder: (_, bool isRefreshedListener, __) => ValueListenableBuilder(
              ...
              builder: (_, String currentUserImageListener, __) => ValueListenableBuilder(
                ...
                builder: (_, bool filterListener, __) => ValueListenableBuilder(
                  valueListenable: deletable,
                    builder: (_, bool deletableListener, __) => Scaffold(
                    appBar: AppBar(
                      ...
                      actions: [
                        MiscRegularDropDownTemplate(postId: widget.postId, likePost: likePost, likesCount: numberOfLikes, reportType: 'Post', pageType: 'Alm', pageName: pageName, deletable: deletableListener),
                      ],
                    ),
