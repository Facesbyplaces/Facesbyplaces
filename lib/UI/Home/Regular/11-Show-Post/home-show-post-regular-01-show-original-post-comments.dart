...
class RegularOriginalComment {
  ...
  const RegularOriginalComment(
      {required this.commentId,
        ...
        required this.commentNumberOfLikes,
        required this.userAccountType,
        required this.listOfReplies});
}
...
class RegularOriginalReply {
  ...
  const RegularOriginalReply(
      {required this.replyId,
        ...
        required this.replyNumberOfLikes,
        required this.userAccountType});
}
...
class HomeRegularShowOriginalPostComments extends StatefulWidget {
  ...
  @override
  HomeRegularShowOriginalPostCommentsState createState() =>
      HomeRegularShowOriginalPostCommentsState(postId: postId);
}

class HomeRegularShowOriginalPostCommentsState
    extends State<HomeRegularShowOriginalPostComments> {
  final int postId;
  ...
  ValueNotifier<List<RegularOriginalComment>> comments =
  ValueNotifier<List<RegularOriginalComment>>([]);
  ValueNotifier<List<RegularOriginalReply>> replies =
  ValueNotifier<List<RegularOriginalReply>>([]);
  int itemRemaining = 1;
  ...
  void getOriginalPostInformation() async {
    var originalPostInformation =
    await apiRegularShowOriginalPost(postId: postId);
    numberOfLikes =
        originalPostInformation.almPost.showOriginalPostNumberOfLikes;
    numberOfComments =
        originalPostInformation.almPost.showOriginalPostNumberOfComments;
  }
  ...
  void onLoading() async {
    if (itemRemaining != 0) {
      var newValue1 =
      await apiRegularShowListOfComments(postId: postId, page: page1);
      ...
      for (int i = 0; i < newValue1.almCommentsList.length; i++) {
        var commentLikeStatus = await apiRegularShowCommentOrReplyLikeStatus(
            commentableType: 'Comment',
            commentableId:
            newValue1.almCommentsList[i].showListOfCommentsCommentId);
        commentsLikes.add(commentLikeStatus.showCommentOrReplyLikeStatus);
        commentsNumberOfLikes
            .add(commentLikeStatus.showCommentOrReplyNumberOfLikes);

        if (repliesRemaining != 0) {
          context.loaderOverlay.show();
          var newValue2 = await apiRegularShowListOfReplies(
              postId: newValue1.almCommentsList[i].showListOfCommentsCommentId,
              page: page2);
          ...
          for (int j = 0; j < newValue2.almRepliesList.length; j++) {
            var replyLikeStatus = await apiRegularShowCommentOrReplyLikeStatus(
                commentableType: 'Reply',
                commentableId:
                newValue2.almRepliesList[j].showListOfRepliesReplyId);
            newRepliesLikes.add(replyLikeStatus.showCommentOrReplyLikeStatus);
            newRepliesNumberOfLikes
                .add(replyLikeStatus.showCommentOrReplyNumberOfLikes);
            newReplyId
                .add(newValue2.almRepliesList[j].showListOfRepliesReplyId);

            replies.value.add(
              RegularOriginalReply(
                replyId: newValue2.almRepliesList[j].showListOfRepliesReplyId,
                commentId:
                newValue2.almRepliesList[j].showListOfRepliesCommentId,
                userId: newValue2.almRepliesList[j].showListOfRepliesUser
                    .showListRepliesUserUserId,
                replyBody:
                newValue2.almRepliesList[j].showListOfRepliesReplyBody,
                createdAt:
                newValue2.almRepliesList[j].showListOfRepliesCreatedAt,
                firstName: newValue2.almRepliesList[j].showListOfRepliesUser
                    .showListRepliesUserFirstName,
                lastName: newValue2.almRepliesList[j].showListOfRepliesUser
                    .showListRepliesUserLastName,
                replyLikes: replyLikeStatus.showCommentOrReplyLikeStatus,
                replyNumberOfLikes:
                replyLikeStatus.showCommentOrReplyNumberOfLikes,
                image: newValue2.almRepliesList[j].showListOfRepliesUser
                    .showListRepliesUserImage,
                userAccountType: newValue2.almRepliesList[j]
                    .showListOfRepliesUser.showListOfCommentsUserAccountType,
              ),
            );
          }
        ...
        comments.value.add(
          RegularOriginalComment(
            ...
            userId: newValue1.almCommentsList[i].showListOfCommentsUser
                .showListOfCommentsUserId,
            commentBody:
            newValue1.almCommentsList[i].showListOfCommentsCommentBody,
            createdAt: newValue1.almCommentsList[i].showListOfCommentsCreatedAt,
            firstName: newValue1.almCommentsList[i].showListOfCommentsUser
                .showListOfCommentsUserFirstName,
            lastName: newValue1.almCommentsList[i].showListOfCommentsUser
                .showListOfCommentsUserLastName,
            image: newValue1.almCommentsList[i].showListOfCommentsUser
                .showListOfCommentsUserImage,
            commentLikes: commentLikeStatus.showCommentOrReplyLikeStatus,
            commentNumberOfLikes:
            commentLikeStatus.showCommentOrReplyNumberOfLikes,
            listOfReplies: replies.value,
            userAccountType: newValue1.almCommentsList[i].showListOfCommentsUser
                .showListOfCommentsUserAccountType,
          ),
        );
        replies.value = [];
      }
          ...
          builder: (_, bool isGuestLoggedInListener, __) =>
              ValueListenableBuilder(
                ...
                builder: (_, int countListener, __) => ValueListenableBuilder(
                  ...
                  builder: (_, List<RegularOriginalComment> commentsListener, __) =>
                      ValueListenableBuilder(
                        valueListenable: replies,
                        builder: (_, List<RegularOriginalReply> repliesListener, __) =>
                            Scaffold(
                              appBar: AppBar(
                              ...
                              body: Stack(
                                children: [
                                  isGuestLoggedInListener
                                    ...
                                    child:
                                    FutureBuilder<APIRegularShowOriginalPostMain>(
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: [
                                                                  ...
                                                                  GestureDetector(
                                                                      onTap:
                                                                        ...
                                                                        if (originalPost
                                                                            ...
                                                                            .showOriginalPostPagePageType ==
                                                                            'Memorial') {
                                                                          if (originalPost.data!.almPost.showOriginalPostPage.showOriginalPostPageManage ==
                                                                              true ||
                                                                              originalPost.data!.almPost.showOriginalPostPage.showOriginalPostPageFamOrFriends ==
                                                                                  true) {
                                                                            Navigator.push(
                                                                                context,
                                                                                MaterialPageRoute(
                                                                      ...
                                                                      child: originalPost
                                                                          ...
                                                                          .almPost
                                                                          .showOriginalPostPage
                                                                          .showOriginalPostPageProfileImage !=
                                                                          ''
                                                                          ? CircleAvatar(
                                                                        backgroundColor:
                                                                        const Color(0xff888888),
                                                                        foregroundImage: NetworkImage(originalPost
                                                                            .data!
                                                                            .almPost
                                                                            .showOriginalPostPage
                                                                            .showOriginalPostPageProfileImage),
                                                                          ...
                                                                          children: [
                                                                            Expanded(
                                                                              ...
                                                                              Align(
                                                                                ...
                                                                                child:
                                                                                Text(
                                                                                  originalPost.data!.almPost.showOriginalPostPage.showOriginalPostPageName,
                                                                                  overflow:
                                                                            ...
                                                                            Expanded(
                                                                              ...
                                                                              Align(
                                                                                ...
                                                                                child:
                                                                                Text(
                                                                                  timeago.format(DateTime.parse(originalPost.data!.almPost.showOriginalPostCreatedAt)),
                                                                                  maxLines:
                                                                                  1,
                                                                                  style:
                                                                                  TextStyle(
                                                            ...
                                                            originalPost
                                                                .data!
                                                                .almPost
                                                                .showOriginalPostImagesOrVideos
                                                                .isNotEmpty
                                                                ? Column(
                                                              children: [
                                                                const SizedBox(
                                                                  ...
                                                                  child: (() {
                                                                    if (originalPost
                                                                      ...
                                                                      return GestureDetector(
                                                                        ...
                                                                        child:
                                                                        (() {
                                                                          if (lookupMimeType(originalPost.data!.almPost.showOriginalPostImagesOrVideos[0])?.contains('video') ==
                                                                              true) {
                                                                            return BetterPlayer.network(
                                                                              '${originalPost.data!.almPost.showOriginalPostImagesOrVideos[0]}',
                                                                              betterPlayerConfiguration: const BetterPlayerConfiguration(
                                                                      ...
                                                                      return StaggeredGridView
                                                                        ...
                                                                        itemBuilder:
                                                                            ...
                                                                            GestureDetector(
                                                                                            ...
                                                                                            children: [
                                                                                              ...
                                                                                              Expanded(
                                                                                                child: CarouselSlider(
                                                                                                  ...
                                                                                                  items: List.generate(
                                                                                                    originalPost.data!.almPost.showOriginalPostImagesOrVideos.length,
                                                                                                        (next) => (() {
                                                                              ...
                                                                              child:
                                                                              (() {
                                                                                if (lookupMimeType(originalPost.data!.almPost.showOriginalPostImagesOrVideos[index])?.contains('video') ==
                                                                                    true) {
                                                                                  return BetterPlayer.network(
                                                                                    '${originalPost.data!.almPost.showOriginalPostImagesOrVideos[index]}',
                                                                                    betterPlayerConfiguration: const BetterPlayerConfiguration(
                                                                      ...
                                                                      Navigator.push(
                                                                          ...
                                                                          MaterialPageRoute(
                                                                              builder: (context) => HomeRegularUserProfile(
                                                                                userId: commentsListener[i].userId,
                                                                                accountType: commentsListener[i].userAccountType,
                                                                              )));
                                                                    },
                                                                    onLongPress:
                                                                        () async {
                                                                      if (currentUserId ==
                                                                          commentsListener[i]
                                                                              .userId &&
                                                                          currentAccountType ==
                                                                              commentsListener[i].userAccountType) {
                                                                        ...
                                                                        Expanded(
                                                                          child: currentUserId == commentsListener[i].userId && currentAccountType == commentsListener[i].userAccountType
                                                                            ...
                                                                            style: TextStyle(
                                                                              ...
                                                                              : Text(
                                                                            '${commentsListener[i].firstName}' + ' ' + '${commentsListener[i].lastName}',
                                                                            style: TextStyle(
                                                                              fontSize: SizeConfig.blockSizeVertical! * 2.11,
                                                                              fontFamily: 'NexaBold',
                                                                              color: const Color(0xff000000),
                                                                    ...
                                                                    Column(
                                                                      children: [
                                                                        ...
                                                                        Row(
                                                                          children: [
                                                                            Text(
                                                                              timeago.format(DateTime.parse(commentsListener[i].createdAt)),
                                                                              style: TextStyle(
                                                                                fontSize: SizeConfig.blockSizeVertical! * 2.11,
                                                                                fontFamily: 'NexaRegular',
                                                                                color: const Color(0xff000000),
                                                                        ...
                                                                        commentsListener[i].listOfReplies.length !=
                                                                            0
                                                                            ? Column(
                                                                                ...
                                                                                subtitle: Column(
                                                                                  children: [
                                                                                    ...
                                                                                    Row(
                                                                                      children: [
                                                                                        Text(
                                                                                          timeago.format(DateTime.parse(commentsListener[i].listOfReplies[index].createdAt)),
                                                                                          style: TextStyle(
                                                                                            fontSize: SizeConfig.blockSizeVertical! * 2.11,
                                                                                            fontFamily: 'NexaRegular',
                                                                                            color: const Color(0xff000000),
            ...
            GestureDetector(
              onTap: () async {
                if (controller.text == '') {
                  ...
                  context.loaderOverlay.show();
                  await apiRegularAddComment(
                      postId: postId, commentBody: controller.text);
                  context.loaderOverlay.hide();
                  ...
                  context.loaderOverlay.show();
                  apiRegularAddReply(
                      commentId: currentCommentId, replyBody: controller.text);
                  context.loaderOverlay.hide();
            ...
            GestureDetector(
              onTap: () async {
                if (controller.text == '') {
                  ...
                  context.loaderOverlay.show();
                  await apiRegularEditComment(
                      commentId: editId, commentBody: controller.text);
                  context.loaderOverlay.hide();
                  ...
                  context.loaderOverlay.show();
                  await apiRegularEditReply(
                      replyId: editId, replyBody: controller.text);
                  context.loaderOverlay.hide();
