      ...
      child: GestureDetector(
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            centerTitle: false,
            title: Text(widget.isAddPassword == true ? 'Add Password' : 'Change Password', textAlign: TextAlign.left, style: const TextStyle(fontSize: 26, fontFamily: 'NexaRegular', color: const Color(0xffffffff)),),
            leading: IconButton(
                        ...
                        if(_key1.currentState!.controller.text == '' || _key2.currentState!.controller.text == ''){
                          await showDialog(
                            ...
                            builder: (_) => AssetGiffyDialog(
                              ...
                              description: const Text('Password can\'t be empty. Please try again.', textAlign: TextAlign.center, style: const TextStyle(fontSize: 24, fontFamily: 'NexaRegular',),),
                              ...
                              if(result){
                                await showDialog(
                                  ...
                                  builder: (_) => AssetGiffyDialog(
                                    ...
                                    description: const Text('Successfully added a password.', textAlign: TextAlign.center, style: const TextStyle(fontSize: 24, fontFamily: 'NexaRegular',),),
                                    image: Image.asset('assets/icons/cover-icon.png', fit: BoxFit.cover,),
                                    entryAnimation: EntryAnimation.DEFAULT,
                                    onlyOkButton: true,
                                    onOkButtonPressed: (){
