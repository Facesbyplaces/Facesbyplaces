...
class HomeRegularMemorialProfileState extends State<HomeRegularMemorialProfile>{
  ...
  Future<APIRegularShowMemorialMain> getProfileInformation(int memorialId) async{
    APIRegularShowMemorialMain? newValue;

    context.loaderOverlay.show();
    newValue = await apiRegularShowMemorial(memorialId: memorialId);
    context.loaderOverlay.hide();
                                        ...
                                        return CustomScrollView(
                                          ...
                                          slivers: <Widget>[
                                            ...
                                            SliverToBoxAdapter(
                                              ...
                                              //   itemCount: lengthOfMemorialPostsListener,
                                              //   itemBuilder: (c, i) {
                                              ...
                                              // child: Column(
                                              //   children: [
                                              //     FutureBuilder<List<APIRegularHomeProfilePostExtended>>(
                                              //       future: showListOfMemorialPosts,
                                              //       builder: (context, posts){
                                              //         if(posts.connectionState == ConnectionState.done){
                                              //           if(loadedListener && lengthOfMemorialPostsListener == 0){
