...
class RegularConnectionListItem {
  ...
  const RegularConnectionListItem(
      {required this.id,
...
class HomeRegularConnectionList extends StatefulWidget {
  ...
  HomeRegularConnectionListState createState() =>
      HomeRegularConnectionListState(
          memorialId: memorialId, newToggle: newToggle);
}
...
class HomeRegularConnectionListState extends State<HomeRegularConnectionList> {
  ...
  void onLoading1() async {
    if (itemRemaining1 != 0) {
      ...
      var newValue = await apiRegularConnectionListFamily(
      ...
      for (int i = 0; i < newValue.almFamilyList.length; i++) {
        listsFamily.add(
          RegularConnectionListItem(
            id: newValue.almFamilyList[i].connectionListFamilyUser
                .connectionListFamilyDetailsId,
            accountType: newValue.almFamilyList[i].connectionListFamilyUser
                .connectionListFamilyAccountType,
            firstName: newValue.almFamilyList[i].connectionListFamilyUser
                .connectionListFamilyDetailsFirstName,
            lastName: newValue.almFamilyList[i].connectionListFamilyUser
                .connectionListFamilyDetailsLastName,
            image: newValue.almFamilyList[i].connectionListFamilyUser
                .connectionListFamilyDetailsImage,
            relationship:
                newValue.almFamilyList[i].connectionListFamilyRelationship,
          ),
        );
      }
  ...
  void onLoading2() async {
    if (itemRemaining2 != 0) {
      context.loaderOverlay.show();
      var newValue = await apiRegularConnectionListFriends(
      ...
      for (int i = 0; i < newValue.almFriendsList.length; i++) {
        listsFriends.add(
          RegularConnectionListItem(
            id: newValue.almFriendsList[i].connectionListFriendsUser
                .connectionListFriendsDetailsId,
            accountType: newValue.almFriendsList[i].connectionListFriendsUser
                .connectionListFriendsAccountType,
            firstName: newValue.almFriendsList[i].connectionListFriendsUser
                .connectionListFriendsDetailsFirstName,
            lastName: newValue.almFriendsList[i].connectionListFriendsUser
                .connectionListFriendsDetailsLastName,
            image: newValue.almFriendsList[i].connectionListFriendsUser
  ...
  void onLoading3() async {
    if (itemRemaining3 != 0) {
      context.loaderOverlay.show();
      var newValue = await apiRegularConnectionListFollowers(
          memorialId: memorialId, page: page3);
      context.loaderOverlay.hide();
      ...
      for (int i = 0; i < newValue.almFollowersList.length; i++) {
        listsFollowers.add(
          RegularConnectionListItem(
            ...
            accountType:
                newValue.almFollowersList[i].connectionListFollowersAccountType,
            firstName: newValue
                .almFollowersList[i].connectionListFollowersDetailsFirstName,
            lastName: newValue
                .almFollowersList[i].connectionListFollowersDetailsLastName,
            image: newValue
                .almFollowersList[i].connectionListFollowersDetailsImage,
        ...
        children: List.generate(
          ...
          (int index) => Column(
            children: [
              ...
              Text(
                '${listsFamily[index].relationship}',
                textAlign: TextAlign.center,
                overflow: TextOverflow.clip,
                maxLines: 1,
                style: TextStyle(
