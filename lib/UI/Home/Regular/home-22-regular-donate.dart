...
//       providers: [
//         BlocProvider<BlocHomeRegularDonate>(create: (context) => BlocHomeRegularDonate(),),
//       ], 
//       child: WillPopScope(
//         onWillPop: () async{
...
//             }
//           },
//           child: BlocBuilder<BlocHomeRegularDonate, int>(
...
//                                   onTap: (){
//                                     context.bloc<BlocHomeRegularDonate>().modify(index);
//                                   },
//                                   child: Container(
//                                     child: Column(
//                                       children: [
                      ...
                      children: [
                        ...
                        MiscRegularButtonTemplate(
                          ...
                          onPressed: () async{
                            ...
                            // // bool canMakePayments = await flutterPay.makePayment();
                            // // bool isCardAvailable = await flutterPay.canMakePaymentsWithActiveCard();

                            // // print('The value of canMakePayments is $canMakePayments');
                            // // print('The value of isCardAvailable is $isCardAvailable');
