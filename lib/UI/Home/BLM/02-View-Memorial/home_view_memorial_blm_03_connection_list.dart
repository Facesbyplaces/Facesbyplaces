...
class HomeBLMConnectionListState extends State<HomeBLMConnectionList>{
  ...
  Future<List<APIBLMConnectionListFamilyExtended>>? showListOfConnectionListFamily;
  ...
  Future<List<APIBLMConnectionListFriendsExtended>>? showListOfConnectionListFriends;
  ...
  Future<List<APIBLMConnectionListFollowersExtendedDetails>>? showListOfConnectionListFollowers;
  ...
  Future<List<APIBLMConnectionListFamilyExtended>> connectionListFamily({required int page}) async{
    APIBLMConnectionListFamilyMain? newValue;
    List<APIBLMConnectionListFamilyExtended> listOfConnectionListFamily = [];

    do{
      newValue = await apiBLMConnectionListFamily(memorialId: widget.memorialId, page: page).onError((error, stackTrace){
        showDialog(
          context: context,
      ...
      listOfConnectionListFamily.addAll(newValue.blmFamilyList);
  ...
  Future<List<APIBLMConnectionListFriendsExtended>> connectionListFriends({required int page}) async{
    APIBLMConnectionListFriendsMain? newValue;
    List<APIBLMConnectionListFriendsExtended> listOfConnectionListFriends = [];

    do{
      newValue = await apiBLMConnectionListFriends(memorialId: widget.memorialId, page: page).onError((error, stackTrace){
        showDialog(
          context: context,
          builder: (context) => CustomDialog(
            image: Image.asset('assets/icons/cover-icon.png', fit: BoxFit.cover,),
      ...
      listOfConnectionListFriends.addAll(newValue.blmFriendsList);
  ...
  Future<List<APIBLMConnectionListFollowersExtendedDetails>> connectionListFollowers({required int page}) async{
    APIBLMConnectionListFollowersMain? newValue;
    List<APIBLMConnectionListFollowersExtendedDetails> listOfConnectionListFollowers = [];

    do{
      newValue = await apiBLMConnectionListFollowers(memorialId: widget.memorialId, page: page).onError((error, stackTrace){
        showDialog(
          context: context,
          builder: (context) => CustomDialog(
            image: Image.asset('assets/icons/cover-icon.png', fit: BoxFit.cover,),
      ...
      listOfConnectionListFollowers.addAll(newValue.blmFollowersList);
      ...
      builder: (_, int lengthOfConnectionListFamilyListener, __) => ValueListenableBuilder(
        ...
        builder: (_, bool loaded1Listener, __) => SafeArea(
          child: RefreshIndicator(
            ...
            child: FutureBuilder<List<APIBLMConnectionListFamilyExtended>>(
      ...
      builder: (_, int lengthOfConnectionListFriendsListener, __) => ValueListenableBuilder(
        ...
        builder: (_, bool loaded2Listener, __) => SafeArea(
          child: RefreshIndicator(
            ...
            child: FutureBuilder<List<APIBLMConnectionListFriendsExtended>>(
      ...
      builder: (_, int lengthOfConnectionListFollowersListener, __) => ValueListenableBuilder(
        ...
        builder: (_, bool loaded3Listener, __) => SafeArea(
          child: RefreshIndicator(
            ...
            child: FutureBuilder<List<APIBLMConnectionListFollowersExtendedDetails>>(
                          ...
                          children: [
                            Expanded(
                              child: GestureDetector(
                                child: CachedNetworkImage(
                                  fit: BoxFit.cover,
                                  imageUrl: connectionListFollowers.data![index].connectionListFollowersImage,
                                  imageBuilder: (context, imageProvider){
                                    return CircleAvatar(
                                      radius: 40,
                                      backgroundColor: const Color(0xff888888),
                                      foregroundImage: NetworkImage(connectionListFollowers.data![index].connectionListFollowersImage),
                                      onForegroundImageError: (object, trace) => Image.asset('assets/icons/user-placeholder.png', fit: BoxFit.contain, scale: 1.0,),
                                    );
                                  },
                                  placeholder: (context, url) => Image.asset('assets/icons/user-placeholder.png', fit: BoxFit.cover, scale: 1.0,),
                                ...
                                onTap: (){
                                  if(connectionListFollowers.data![index].connectionListFollowersAccountType == 1){
                                    Navigator.push(context, MaterialPageRoute(builder: (context) => HomeBLMUserProfile(userId: connectionListFollowers.data![index].connectionListFollowersId, accountType: connectionListFollowers.data![index].connectionListFollowersAccountType)));
                                  }else{
                                    Navigator.push(context, MaterialPageRoute(builder: (context) => HomeRegularUserProfile(userId: connectionListFollowers.data![index].connectionListFollowersId, accountType: connectionListFollowers.data![index].connectionListFollowersAccountType)));
                                  }
                                },
                              ),
                            ),
                            ...
                            Text('${connectionListFollowers.data![index].connectionListFollowersFirstName} ${connectionListFollowers.data![index].connectionListFollowersLastName}',
                              style: const TextStyle(fontSize: 20, fontFamily: 'NexaRegular', color: Color(0xff2F353D),),
                              textAlign: TextAlign.center,
                              overflow: TextOverflow.clip,
                              maxLines: 1,
                    ...
                    : GridView.count(
                      ...
                      children: List.generate(
                        lengthOfConnectionListFollowersListener, (int index){
                          return connectionListFollowers.data![index].connectionListFollowersLastName.toUpperCase().contains(searchKey.toUpperCase()) ||
                          connectionListFollowers.data![index].connectionListFollowersLastName.toUpperCase().contains(searchKey.toUpperCase())
                          ? Column(
                            children: [
                              Expanded(
                                child: GestureDetector(
