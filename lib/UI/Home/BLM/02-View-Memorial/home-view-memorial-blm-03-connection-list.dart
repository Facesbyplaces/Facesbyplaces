...
class HomeBLMConnectionList extends StatefulWidget {
  ...
  HomeBLMConnectionListState createState() =>
      HomeBLMConnectionListState(memorialId: memorialId, newToggle: newToggle);
}

class HomeBLMConnectionListState extends State<HomeBLMConnectionList> {
  final int memorialId;
  final int newToggle;
  HomeBLMConnectionListState(
      {required this.memorialId, required this.newToggle});
  ...
  void onLoading1() async {
    if (itemRemaining1 != 0) {
      ...
      var newValue =
          await apiBLMConnectionListFamily(memorialId: memorialId, page: page1);
  ...
  void onLoading2() async {
    if (itemRemaining2 != 0) {
      context.loaderOverlay.show();
      var newValue = await apiBLMConnectionListFriends(
  ...
  void onLoading3() async {
    if (itemRemaining3 != 0) {
      context.loaderOverlay.show();
      var newValue = await apiBLMConnectionListFollowers(
