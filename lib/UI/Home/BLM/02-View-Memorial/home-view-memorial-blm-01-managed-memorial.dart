                                                ...
                                                children: [
                                                  Row(
                                                    children: [
                                                      ...
                                                      Expanded(child: Text(profile.data!.blmMemorial.memorialDetails.memorialDetailsCountry, style: TextStyle(fontSize: SizeConfig.blockSizeVertical! * 1.76, fontFamily: 'NexaRegular', color: const Color(0xff000000),),),),
                                                    ],
                                                  ),
                                        ...
                                        children: [
                                          ...
                                          Expanded(
                                            child: Container(
                                              ...
                                              ? MaterialButton(
                                                child: Text('Create Post', style: TextStyle(fontSize: SizeConfig.blockSizeVertical! * 3.16, color: const Color(0xffFFFFFF), fontFamily: 'NexaRegular'),),
                                                onPressed: () async{
                            ...
                            children: List.generate(
                              posts.length, (i) => Padding(
                                ...
                                child: MiscBLMPost(
                                  ...
                                  contents: [
                                    Container(alignment: Alignment.centerLeft, child: Text(posts[i].postBody, overflow: TextOverflow.ellipsis, maxLines: 5, style: TextStyle(fontSize: SizeConfig.blockSizeVertical! * 2.11, fontFamily: 'NexaRegular', color: const Color(0xff000000),),),),
