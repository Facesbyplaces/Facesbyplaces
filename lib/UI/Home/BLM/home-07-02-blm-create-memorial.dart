                ...
                MiscBLMButtonTemplate(
                  onPressed: () async{
                    if(_key1.currentState.controller.text == ''){
                      ...
                      print('The newValue is ${newValue.blmName}');
                      print('The newValue is ${newValue.description}');
                      print('The newValue is ${newValue.location}');
                      print('The newValue is ${newValue.dob}');
                      print('The newValue is ${newValue.rip}');
                      print('The newValue is ${newValue.state}');
                      print('The newValue is ${newValue.country}');
                      print('The newValue is ${newValue.precinct}');
                      print('The newValue is ${newValue.relationship}');
