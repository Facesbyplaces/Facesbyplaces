...
class HomeBLMPostTabState extends State<HomeBLMPostTab> with AutomaticKeepAliveClientMixin<HomeBLMPostTab>{
  Future<List<APIBLMHomeTabPostExtended>>? showListOfPosts;
  ...
  Future<List<APIBLMHomeTabPostExtended>> getListOfPosts({required int page}) async{
    APIBLMHomeTabPostMain? newValue;
    List<APIBLMHomeTabPostExtended> listOfPosts = [];

    do{
      newValue = await apiBLMHomePostTab(page: page).onError((error, stackTrace){
        showDialog(
          context: context,
      ...
      builder: (_, int lengthOfPostsListener, __) => ValueListenableBuilder(
        ...
        builder: (_, bool loadedListener, __) => SafeArea(
          child: RefreshIndicator(
            onRefresh: onRefresh,
            child: FutureBuilder<List<APIBLMHomeTabPostExtended>>(
