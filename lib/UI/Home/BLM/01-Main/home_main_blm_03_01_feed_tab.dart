...
class HomeBLMFeedTabState extends State<HomeBLMFeedTab> with AutomaticKeepAliveClientMixin<HomeBLMFeedTab>{
  Future<List<APIBLMHomeTabFeedExtended>>? showListOfFeeds;
  ...
  Future<List<APIBLMHomeTabFeedExtended>> getListOfFeeds({required int page}) async{
    APIBLMHomeTabFeedMain? newValue;
    List<APIBLMHomeTabFeedExtended> listOfFeeds = [];

    do{
      newValue = await apiBLMHomeFeedTab(page: page).onError((error, stackTrace){
        showDialog(
          context: context,
      ...
      listOfFeeds.addAll(newValue.blmFamilyMemorialList);
        ...
        builder: (_, int lengthOfFeedsListener, __) => ValueListenableBuilder(
          ...
          builder: (_, bool loadedListener, __) => SafeArea(
            child: RefreshIndicator(
              onRefresh: onRefresh,
              child: FutureBuilder<List<APIBLMHomeTabFeedExtended>>(
