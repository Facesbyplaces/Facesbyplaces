...
class HomeBLMShowOriginalPostComments extends StatefulWidget {
  ...
  @override
  HomeBLMShowOriginalPostCommentsState createState() =>
      HomeBLMShowOriginalPostCommentsState(postId: postId);
}

class HomeBLMShowOriginalPostCommentsState
    extends State<HomeBLMShowOriginalPostComments> {
  final int postId;
  HomeBLMShowOriginalPostCommentsState({required this.postId});

  ScrollController scrollController = ScrollController();
  TextEditingController controller = TextEditingController(text: '');
  ValueNotifier<List<BLMOriginalComment>> comments =
  ValueNotifier<List<BLMOriginalComment>>([]);
  ValueNotifier<List<BLMOriginalReply>> replies =
  ValueNotifier<List<BLMOriginalReply>>([]);
  ...
  void getOriginalPostInformation() async {
    ...
    numberOfLikes =
        originalPostInformation.blmPost.showOriginalPostNumberOfLikes;
    numberOfComments =
        originalPostInformation.blmPost.showOriginalPostNumberOfComments;
  }
  ...
  void onLoading() async {
    if (itemRemaining != 0) {
      var newValue1 =
      await apiBLMShowListOfComments(postId: postId, page: page1);
      ...
      for (int i = 0; i < newValue1.blmCommentsList.length; i++) {
        var commentLikeStatus = await apiBLMShowCommentOrReplyLikeStatus(
            commentableType: 'Comment',
            commentableId:
            newValue1.blmCommentsList[i].showListCommentsCommentId);
        ...
        if (repliesRemaining != 0) {
          ...
          var newValue2 = await apiBLMShowListOfReplies(
              postId: newValue1.blmCommentsList[i].showListCommentsCommentId,
              page: page2);
          ...
          for (int j = 0; j < newValue2.blmRepliesList.length; j++) {
            var replyLikeStatus = await apiBLMShowCommentOrReplyLikeStatus(
                commentableType: 'Reply',
                commentableId:
                newValue2.blmRepliesList[j].showListRepliesReplyId);
            ...
            replies.value.add(
              BLMOriginalReply(
                ...
                userId: newValue2.blmRepliesList[j].showListRepliesUser
                ...
                firstName: newValue2.blmRepliesList[j].showListRepliesUser
                    .showListRepliesUserFirstName,
                lastName: newValue2.blmRepliesList[j].showListRepliesUser
                ...
                image: newValue2.blmRepliesList[j].showListRepliesUser
                    .showListRepliesUserImage,
                userAccountType: newValue2.blmRepliesList[j].showListRepliesUser
                    .showListRepliesUserAccountType,
              ),
            );
          }
        ...
        comments.value.add(
          BLMOriginalComment(
            ...
            userId: newValue1.blmCommentsList[i].showListCommentsUser
                .showListCommentsUserUserId,
            commentBody:
            newValue1.blmCommentsList[i].showListCommentsCommentBody,
            createdAt: newValue1.blmCommentsList[i].showListCommentsCreatedAt,
            firstName: newValue1.blmCommentsList[i].showListCommentsUser
                .showListCommentsUserFirstName,
            lastName: newValue1.blmCommentsList[i].showListCommentsUser
                .showListCommentsUserLastName,
            image: newValue1.blmCommentsList[i].showListCommentsUser
                .showListCommentsUserImage,
            ...
            userAccountType: newValue1.blmCommentsList[i].showListCommentsUser
                .showListCommentsUserAccountType,
          ),
        );
        replies.value = [];
      }
          ...
          builder: (_, bool isGuestLoggedInListener, __) =>
              ValueListenableBuilder(
                ...
                builder: (_, int countListener, __) => ValueListenableBuilder(
                  ...
                  builder: (_, List<BLMOriginalComment> commentsListener, __) =>
                      ValueListenableBuilder(
                        valueListenable: replies,
                        builder: (_, List<BLMOriginalReply> repliesListener, __) =>
                            Scaffold(
                              appBar: AppBar(
                                                                      ...
                                                                      onTap: () async {
                                                                        if (originalPost
                                                                          ...
                                                                          if (originalPost
                                                                              ...
                                                                              .blmPost
                                                                              .showOriginalPostPage
                                                                              .showOriginalPostPageManage ==
                                                                              true ||
                                                                              originalPost
                                                                                  .data!
                                                                                  .blmPost
                                                                                  .showOriginalPostPage
                                                                                  .showOriginalPostPageFamOrFriends ==
                                                                                  true) {
                                                                            Navigator.push(
                                                                                context,
                                                                                MaterialPageRoute(
                                                                                    builder: (context) => HomeRegularProfile(
                                                                                      memorialId: originalPost.data!.blmPost.showOriginalPostPage.showOriginalPostPageId,
                                                                            ...
                                                                            Navigator.push(
                                                                                ...
                                                                                MaterialPageRoute(
                                                                                    builder: (context) => HomeRegularMemorialProfile(
                                                                                      memorialId: originalPost.data!.blmPost.showOriginalPostPage.showOriginalPostPageId,
                                                                                      pageType: originalPost.data!.blmPost.showOriginalPostPage.showOriginalPostPagePageType,
                                                                                      newJoin: originalPost.data!.blmPost.showOriginalPostPage.showOriginalPostPageFollower,
                                                                                    )));
                                                                          }
                                                                        } else {
                                                                          if (originalPost
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Expanded(
                                                                              ...
                                                                              Align(
                                                                                ...
                                                                                child:
                                                                                Text(
                                                                                  timeago.format(DateTime.parse(originalPost
                                                                                      .data!
                                                                                      .blmPost
                                                                                      .showOriginalPostCreatedAt)),
                                                                                  maxLines:
                                                                                  1,
                                                                                  style:
                                                                                  TextStyle(
                                                                  ...
                                                                  child: (() {
                                                                    if (originalPost
                                                                      ...
                                                                      return GestureDetector(
                                                                        ...
                                                                        child: (() {
                                                                          if (lookupMimeType(originalPost.data!.blmPost.showOriginalPostImagesOrVideos[0])
                                                                              ?.contains('video') ==
                                                                              true) {
                                                                            return BetterPlayer
                                                                                .network(
                                                                            ...
                                                                            return CachedNetworkImage(
                                                                              fit: BoxFit
                                                                                  .cover,
                                                                              imageUrl: originalPost
                                                                                  .data!
                                                                                  .blmPost
                                                                                  .showOriginalPostImagesOrVideos[0],
                                                                      ...
                                                                      return StaggeredGridView
                                                                        ...
                                                                        itemBuilder:
                                                                            ...
                                                                            GestureDetector(
                                                                                            ...
                                                                                            children: [
                                                                                              ...
                                                                                              Expanded(
                                                                                                child: CarouselSlider(
                                                                                                  ...
                                                                                                  items: List.generate(
                                                                                                    originalPost.data!.blmPost.showOriginalPostImagesOrVideos.length,
                                                                                                        (next) => (() {
                                                                              ...
                                                                              child:
                                                                              (() {
                                                                                if (lookupMimeType(originalPost.data!.blmPost.showOriginalPostImagesOrVideos[index])?.contains('video') ==
                                                                                    true) {
                                                                                  return BetterPlayer
                                                                                      .network(
                                                                                    '${originalPost.data!.blmPost.showOriginalPostImagesOrVideos[index]}',
                                                                            ...
                                                                            GestureDetector(
                                                                              ...
                                                                              (() {
                                                                                if (index !=
                                                                                  ...
                                                                                  return (() {
                                                                                    if (originalPost.data!.blmPost.showOriginalPostImagesOrVideos.length - 3 >
                                                                                        0) {
                                                                          ...
                                                                          TextSpan(
                                                                            ...
                                                                            List.generate(
                                                                              originalPost
                                                                                  ...
                                                                                  TextSpan(
                                                                                    style:
                                                                                    const TextStyle(fontWeight: FontWeight.bold, color: const Color(0xff000000)),
                                                                                    children: <TextSpan>[
                                                                                      TextSpan(
                                                            ...
                                                            List.generate(
                                                              commentsListener
                                                                ...
                                                                title: Row(
                                                                  children: [
                                                                    Expanded(
                                                                      child: currentUserId == commentsListener[i].userId &&
                                                                          currentAccountType == commentsListener[i].userAccountType
                                                                          ? Text(
                                                                        'You',
                                                                        style: TextStyle(
                                                                          fontSize: SizeConfig.blockSizeVertical! * 2.11,
                                                                ...
                                                                Column(
                                                                  children: [
                                                                    ...
                                                                    Row(
                                                                      children: [
                                                                        Text(timeago
                                                                            .format(DateTime.parse(commentsListener[i].createdAt)),
                                                                          style: TextStyle(
                                                                            fontSize: SizeConfig.blockSizeVertical! * 2.11,
                                                                            fontFamily: 'NexaRegular',
                                                                            color: const Color(0xff000000),
