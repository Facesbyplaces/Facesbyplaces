...
//   Future<APIBLMShowListOfCommentsDuplicate> getListOfComments(BuildContext context) async{
...
//                                         child: FutureBuilder<APIBLMShowListOfCommentsDuplicate>(
//                                           future: getListOfComments(context),
...
class HomeBLMShowOriginalPostCommentsState extends State<HomeBLMShowOriginalPostComments>{
  ...
  Future<List<APIBLMShowListOfCommentsExtended>> getListOfComments({required int page}) async{
    ...
    for(int i = 0; i < listOfComments.length; i++){
      APIBLMShowCommentOrReplyLikeStatus commentLikeStatus = await apiBLMShowCommentOrReplyLikeStatus(commentableType: 'Comment', commentableId: listOfComments[i].showListCommentsCommentId);
      commentsNumberOfLikes.add(commentLikeStatus.showCommentOrReplyNumberOfLikes);
      commentsLikes.add(commentLikeStatus.showCommentOrReplyLikeStatus);
    }
  ...
  Future<List<APIBLMShowListOfRepliesExtended>> getListOfReplies({required int commentId, required int page}) async{
    ...
    for(int i = 0; i < listOfReplies.length; i++){
      APIBLMShowCommentOrReplyLikeStatus replyLikeStatus = await apiBLMShowCommentOrReplyLikeStatus(commentableType: 'Reply', commentableId: listOfReplies[i].showListRepliesCommentId);
                                                  ...
                                                  title: Row(
                                                    children: [
                                                      ...
                                                      Expanded(
                                                        child: Align(
                                                          alignment: Alignment.centerRight,
                                                          child: MiscLikeButtonTemplate(likeStatus: commentsLikes[i], numberOfLikes: commentsNumberOfLikes[i], commentableType: 'Comment', commentableId: listOfComments.data![i].showListCommentsCommentId),
                                                        )
                                                      ),
                                                    ],
                                                  ),
                                                                ...
                                                                title: Row(
                                                                  children: [
                                                                    ...
                                                                    Expanded(
                                                                      child: Align(
                                                                        alignment: Alignment.centerRight,
                                                                        child: MiscLikeButtonTemplate(likeStatus: repliesLikes[index], numberOfLikes: repliesNumberOfLikes[index], commentableType: 'Reply', commentableId: listOfReplies.data![index].showListRepliesReplyId),
                                                                      ),
                                                                    ),
                                                                  ],
                                                                ),
