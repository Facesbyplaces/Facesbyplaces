...
class HomeBLMPageDetails extends StatefulWidget {
  ...
  HomeBLMPageDetailsState createState() =>
      HomeBLMPageDetailsState(memorialId: memorialId);
}
...
class HomeBLMPageDetailsState extends State<HomeBLMPageDetails> {
  ...
  final GlobalKey<MiscBLMInputFieldTemplateState> _key2 =
      GlobalKey<MiscBLMInputFieldTemplateState>();
  final GlobalKey<MiscBLMInputFieldDropDownState> _key3 =
  ...
  final GlobalKey<MiscBLMInputFieldTemplateState> _key7 =
      GlobalKey<MiscBLMInputFieldTemplateState>();
  final GlobalKey<MiscBLMInputFieldTemplateState> _key8 =
      GlobalKey<MiscBLMInputFieldTemplateState>();
  final GlobalKey<MiscBLMInputFieldTemplateState> _key9 =
      GlobalKey<MiscBLMInputFieldTemplateState>();
  ...
  Future<APIBLMShowPageDetailsMain> getMemorialSettings(int memorialId) async {
    ...
    controller1 = TextEditingController(
        text: newValue
            .blmMemorial.showPageDetailsDetails.showPageDetailsDetailsDob);
    controller2 = TextEditingController(
        text: newValue
            .blmMemorial.showPageDetailsDetails.showPageDetailsDetailsRip);
                        ...
                        child: ListView(
                          ...
                          children: [
                            MiscBLMInputFieldTemplate(
                              ...
                              displayText: memorialSettings
                                  .data!.blmMemorial.showPageDetailsName,
                            ),
                            const SizedBox(
                              height: 20,
                            ),
                            MiscBLMInputFieldTemplate(
                              ...
                              displayText: memorialSettings
                                  .data!
                                  .blmMemorial
                                  .showPageDetailsDetails
                                  .showPageDetailsDetailsDescription,
                            ),
                            const SizedBox(
                              height: 20,
                            ),
                            MiscBLMInputFieldDropDown(
                              key: _key3,
                              displayText: memorialSettings.data!.blmMemorial
                                  .showPageDetailsRelationship,
                            ),
                            const SizedBox(
                              height: 20,
                            ),
                            MiscBLMInputFieldTemplate(
                              ...
                              displayText: memorialSettings
                                  ...
                                  .blmMemorial
                                  .showPageDetailsDetails
                                  .showPageDetailsDetailsLocation,
                            ),
                            const SizedBox(
                              height: 20,
                            ),
                            ...
                            MiscBLMInputFieldTemplate(
                              ...
                              displayText: memorialSettings
                                  ...
                                  .blmMemorial
                                  .showPageDetailsDetails
                                  .showPageDetailsDetailsPrecinct,
                              labelTextStyle: TextStyle(
                                fontSize: SizeConfig.blockSizeVertical! * 2.11,
                                fontFamily: 'NexaRegular',
                                color: const Color(0xffBDC3C7),
                            ...
                            MiscBLMButtonTemplate(
                              ...
                              onPressed: () async {
                                if (memorialSettings.data!.blmMemorial.showPageDetailsName !=
                                    ...
                                    memorialSettings.data!.blmMemorial
                                            .showPageDetailsRelationship !=
                                        _key3.currentState!.currentSelection ||
                                    memorialSettings
                                            .data!
                                            .blmMemorial
                                            .showPageDetailsDetails
                                    ...
                                    memorialSettings
                                            ...
                                            .blmMemorial
                                            .showPageDetailsDetails
                                            .showPageDetailsDetailsDob !=
                                        controller1.text ||
                                    memorialSettings
                                            .data!
                                            .blmMemorial
                                            .showPageDetailsDetails
                                            .showPageDetailsDetailsRip !=
                                        controller2.text ||
                                    memorialSettings
                                            .data!
                                            .blmMemorial
                                    ...
                                    memorialSettings
                                            ...
                                            .showPageDetailsDetails
                                            .showPageDetailsDetailsCountry !=
                                        _key8.currentState!.controller.text ||
                                    memorialSettings
                                            .data!
                                            .blmMemorial
                                            .showPageDetailsDetails
                                            .showPageDetailsDetailsPrecinct !=
                                        _key9.currentState!.controller.text) {
