...
class HomeBLMMemorialSettingsLocateMap extends StatefulWidget{
  const HomeBLMMemorialSettingsLocateMap({Key? key}) : super(key: key);

  @override
  HomeBLMMemorialSettingsLocateMapState createState() => HomeBLMMemorialSettingsLocateMapState();
}

class HomeBLMMemorialSettingsLocateMapState extends State<HomeBLMMemorialSettingsLocateMap>{
