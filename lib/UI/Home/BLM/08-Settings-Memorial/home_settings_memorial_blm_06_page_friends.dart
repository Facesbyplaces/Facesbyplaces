...
class HomeBLMPageFriendsState extends State<HomeBLMPageFriends>{
  Future<List<APIBLMShowFriendsSettingsExtended>>? showListOfFriends;
  ...
  Future<List<APIBLMShowFriendsSettingsExtended>> getListOfFriends({required int page}) async{
    APIBLMShowFriendsSettingsMain? newValue;
    List<APIBLMShowFriendsSettingsExtended> listOfFriends = [];

    do{
      newValue = await apiBLMShowFriendsSettings(memorialId: widget.memorialId, page: page).onError((error, stackTrace){
        showDialog(
          context: context,
      ...
      listOfFriends.addAll(newValue.blmFriendsList);
        ...
        builder: (_, bool loadedListener, __) => Scaffold(
          ...
          body: SafeArea(
            child: RefreshIndicator(
              onRefresh: onRefresh,
              child: FutureBuilder<List<APIBLMShowFriendsSettingsExtended>>(
                            ...
                            trailing: MaterialButton(
                              ...
                              onPressed: () async{
                                ...
                                if(confirmation){
                                  ...
                                  String result = await apiBLMDeleteMemorialFriendsOrFamily(memorialId: widget.memorialId, userId: friends.data![i].showFriendsSettingsUser.showFriendsSettingsDetailsId, accountType: friends.data![i].showFriendsSettingsUser.showFriendsSettingsDetailsAccountType);
