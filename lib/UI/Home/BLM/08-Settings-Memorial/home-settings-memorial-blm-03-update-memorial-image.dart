...
class HomeBLMMemorialPageImage extends StatefulWidget {
  ...
  HomeBLMMemorialPageImageState createState() =>
      HomeBLMMemorialPageImageState(memorialId: memorialId);
}
...
class HomeBLMMemorialPageImageState extends State<HomeBLMMemorialPageImage> {
  ...
  final List<String> backgroundImages = [
    'assets/icons/profile_post1.png',
    'assets/icons/profile_post2.png',
    'assets/icons/profile_post3.png',
    'assets/icons/profile_post4.png'
  ];
                            ...
                            image: backgroundImage.path != ''
                                ...
                                : DecorationImage(
                                    ...
                                    image: CachedNetworkImageProvider(
                                        '${memorialImageSettings.data!.blmMemorial.showPageImagesBackgroundImage}')),
                          ),
                          child: Stack(
                            children: [
                              GestureDetector(
                        ...
                        MiscBLMButtonTemplate(
                          ...
                          onPressed: () async {
                            if (profileImage.path != '' ||
                              ...
                              bool result = await apiBLMUpdatePageImages(
                              ...
                              if (result) {
                                ...
                                Navigator.of(context).pushAndRemoveUntil(
                                    route, ModalRoute.withName('/home/blm'));
                              } else {
                                await showDialog(
                                    context: context,
                                    builder: (_) => AssetGiffyDialog(
