...
class HomeBLMConnectionListFriends extends StatefulWidget{

  HomeBLMConnectionListFriendsState createState() => HomeBLMConnectionListFriendsState();
}

class HomeBLMConnectionListFriendsState extends State<HomeBLMConnectionListFriends>{
