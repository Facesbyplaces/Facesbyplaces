...
// class HomeBLMMemorialPageImage extends StatelessWidget{
  ...
  Widget build(BuildContext context){
    ...
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider<BlocHomeBLMBackgroundImage>(create: (context) => BlocHomeBLMBackgroundImage(),),
      ], 
          ...
          return BlocBuilder<BlocHomeBLMBackgroundImage, int>( 
            builder: (context, backgroundImageToggle){
              return Scaffold(
                ...
                //   child: ((){
                //   switch(loading){
                //     // case false: return FutureBuilder<APIBLMShowPageImagesMain>(
                //     //   future: apiBLMShowPageImages(),
