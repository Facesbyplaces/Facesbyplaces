                    ...
                    children: [
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () async{
                                AuthorizationCredentialAppleID credential = await SignInWithApple.getAppleIDCredential(
                                  ...
                                  webAuthenticationOptions: WebAuthenticationOptions(clientId: 'com.app.facesbyplaces', redirectUri: Uri.parse('https://com.app.facesbyplaces.glitch.me/callbacks/sign_in_with_apple'),),
                                );
                      ...
                      Container(
                        ...
                        child: RichText(
                          text: TextSpan(
                            children: <TextSpan>[
                              TextSpan(text: 'Connect  /  ', style: TextStyle(fontSize: SizeConfig.blockSizeVertical! * 2.5, fontFamily: 'NexaRegular', color: const Color(0xffBDC3C7),),),

                              TextSpan(text: 'Remember  /  ', style: TextStyle(fontSize: SizeConfig.blockSizeVertical! * 2.5, fontFamily: 'NexaRegular', color: const Color(0xffBDC3C7),),),

                              TextSpan(text: 'Honor', style: TextStyle(fontSize: SizeConfig.blockSizeVertical! * 2.5, fontFamily: 'NexaRegular', color: const Color(0xffBDC3C7),),),
                            ],
                          ),
                        ),
                      ),
