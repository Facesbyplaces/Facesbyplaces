...
import 'package:facesbyplaces/UI/Regular/regular_06_password_reset_email.dart';
                                  ...
                                  MiscButtonTemplate(
                                    ...
                                    onPressed: () async{
                                      ...
                                      if(!(_formKey.currentState!.validate())){
                                        ...
                                        String result = await apiRegularLogin(email: _key1.currentState!.controller.text, password: _key2.currentState!.controller.text, deviceToken: deviceToken).onError((error, stackTrace){
                                          context.loaderOverlay.hide();
                                          showDialog(
                                            context: context,
                                            builder: (context) => CustomDialog(
