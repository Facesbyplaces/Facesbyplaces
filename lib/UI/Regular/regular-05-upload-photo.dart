                ...
                GestureDetector(
                  onTap: () async {
                    var choice = await showDialog(
                        context: (context),
                        builder: (build) => MiscRegularUploadFromDialog());
                    ...
                    child: Column(
                      children: [
                        ...
                        Expanded(
                          child: Center(
                            child: Text(
                              'A valid photo of yourself would be a better choice because it would be worth a thousand words.',
                ...
                MiscRegularButtonTemplate(
                  ...
                  onPressed: () async {
                    if (imageListener.path != '') {
                      ...
                      bool result =
                          await apiRegularUploadPhoto(image: imageListener);
