            ...
            child: Column(
              children: [
                ...
                RichText(
                  text: const TextSpan(
                    children: <TextSpan>[
                      const TextSpan(text: 'Connect / ', style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w300, color: const Color(0xff888888),),),

                      const TextSpan(text: 'Remember / ', style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w300, color: const Color(0xff888888),),),

                      const TextSpan(text: 'Honor', style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w300, color: const Color(0xff888888),),),
                    ],
                  ),
                ),
