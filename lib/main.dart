...
void main(){
  runApp(
    MaterialApp(
      title: 'Faces by Places',
      // home: HomePage(),
      home: FacesByPlacesHome(),
      routes: <String, WidgetBuilder>{
        'ui-02-login': (BuildContext onctext) => UILogin01(),
        'ui-03-login02': (BuildContext onctext) => UILogin02(),
        'blm-01-join': (BuildContext onctext) => BLMJoin(),
        'blm-02-login': (BuildContext onctext) => BLMLogin(),
        'blm-03-register': (BuildContext onctext) => BLMRegister(),
        'blm-04-verify-email': (BuildContext onctext) => BLMVerifyEmail(),
        'blm-05-upload-photo': (BuildContext onctext) => BLMUploadPhoto(),
      },
    ),
  );
}
