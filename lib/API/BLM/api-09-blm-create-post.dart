...
Future<bool> apiBLMHomeCreatePost(APIBLMCreatePost post) async{
  ...
  try{
    ...
    formData.files.addAll([
      ...
      MapEntry('post[page_id]', MultipartFile.fromString(prefsUserID.toString()),),
    ...
    print('The status code in blm create post is ${response.statusCode}');
    print('The status code in blm create post is ${response.data}');
