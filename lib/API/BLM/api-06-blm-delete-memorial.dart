...
Future<bool> apiBLMDeleteMemorial() async{
  ...
  // print('The response status in blm delete memorial is ${response.statusCode}');
  // print('The response status in blm delete memorial is ${response.body}');
