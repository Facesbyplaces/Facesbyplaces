...
Future<bool> apiBLMAddPassword({required String newPassword}) async{
  ...
  // var response = await dioRequest.put('http://45.33.66.25:3001/auth/password', data: formData,
  var response = await dioRequest.put('http://facesbyplaces.com/auth/password', data: formData,
    options: Options(
