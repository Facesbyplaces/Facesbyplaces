...
class APIBLMSearchMemorialMain{
  int blmItemsRemaining;
  List<APIBLMSearchMemorialExtended> blmMemorialList;
  APIBLMSearchMemorialMain({required this.blmItemsRemaining, required this.blmMemorialList});
...
class APIBLMSearchMemorialExtended{
  int searchMemorialId;
  APIBLMSearchMemorialExtendedPage searchMemorialPage;
  APIBLMSearchMemorialExtended({required this.searchMemorialId, required this.searchMemorialPage});

  factory APIBLMSearchMemorialExtended.fromJson(Map<String, dynamic> parsedJson){
    return APIBLMSearchMemorialExtended(
      searchMemorialId: parsedJson['id'],
      searchMemorialPage: APIBLMSearchMemorialExtendedPage.fromJson(parsedJson['page']),
    );
  }
}
...
class APIBLMSearchMemorialExtendedPage{
  ...
  bool searchMemorialFollower;
  String searchMemorialPageType;
  APIBLMSearchMemorialExtendedPage({required this.searchMemorialId, required this.searchMemorialName, required this.searchMemorialDetails, required this.searchMemorialProfileImage, required this.searchMemorialRelationship, required this.searchMemorialManage, required this.searchMemorialFamOrFriends, required this.searchMemorialFollower, required this.searchMemorialPageType});
