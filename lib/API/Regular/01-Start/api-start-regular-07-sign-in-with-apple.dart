...
Future<bool> apiRegularSignInWithApple({required String userIdentification, required String identityToken}) async{
  ...
  final http.Response response = await http.post(
    Uri.http('http://fbp.dev1.koda.ws/alm_auth/sign_in?account_type=2&first_name=&last_name=&user_identification=$userIdentification&identity_token=$identityToken&image=', ''),
