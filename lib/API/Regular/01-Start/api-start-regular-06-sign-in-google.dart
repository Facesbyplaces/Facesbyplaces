...
Future<bool> apiRegularSignInWithGoogle({required String firstName, required String lastName, required String email, required String username, required String googleId, required String image}) async{
  ...
  try{
    ...
    print('The status code of login with google is ${response.statusCode}');
    ...
    print('The error of login with google is: $e');
    return result;
  }
}
  ...
  //   Uri.http('http://fbp.dev1.koda.ws/alm_auth/sign_in?account_type=2&first_name=$firstName&last_name=$lastName&email=$email&username=$username&google_id=$googleId&image=$image', ''),
