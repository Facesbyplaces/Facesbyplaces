...
class APIRegularShowListOfRepliesExtendedUserDuplicate{
  ...
  APIRegularShowListOfRepliesExtendedUserDuplicate({required this.showListRepliesUserUserId, required this.showListRepliesUserFirstName, required this.showListRepliesUserLastName, required this.showListRepliesUserImage, required this.showListRepliesUserAccountType});
