...
Future<APIRegularShowProfileInformation> apiRegularShowProfileInformation() async{
  ...
  print('The show user information status code is ${response.statusCode}');
  print('The show user information status body is ${response.body}');
...
class APIRegularShowProfileInformation{
  ...
  APIRegularShowProfileInformation({this.userId, this.firstName, this.lastName, this.image, this.email, this.guest});
