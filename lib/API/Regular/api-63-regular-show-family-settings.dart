...
Future<APIRegularShowFamilySettingsMain> apiRegularShowFamilySettings(int memorialId, int page) async{
  ...
  final http.Response response = await http.get('http://fbp.dev1.koda.ws/api/v1/pages/memorial/$memorialId/family/index?page=$page',
...
class APIRegularShowFamilySettingsExtendedDetails{
  ...
  APIRegularShowFamilySettingsExtendedDetails({this.id, this.firstName, this.lastName, this.image});
