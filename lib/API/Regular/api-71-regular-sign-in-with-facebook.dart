...
Future<bool> apiRegularSignInWithFacebook({String firstName, String lastName, String email, String username, String facebookId, String image}) async{
  ...
  final http.Response response = await http.post(
    ...
    // 'http://fbp.dev1.koda.ws/auth?account_type=2&first_name=$firstName&last_name=$lastName&phone_number=123123123&email=$email&username=$username&facebook_id=$facebookId',
    'http://fbp.dev1.koda.ws/auth/sign_in?account_type=2&first_name=$firstName&last_name=$lastName&phone_number=123123123&email=$email&username=$username&facebook_id=$facebookId&image=$image',
