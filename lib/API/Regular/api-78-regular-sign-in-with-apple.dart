...
// Future<bool> apiRegularSignInWithApple({String firstName, String lastName, String email, String username, String userIdentification, String identityToken, String image}) async{

Future<bool> apiRegularSignInWithApple({String userIdentification, String identityToken}) async{

  final http.Response response = await http.post(
    // 'http://fbp.dev1.koda.ws/auth/sign_in?account_type=2&first_name=$firstName&last_name=$lastName&email=$email&username=$username&user_identification=$userIdentification&identity_token=$identityToken&image=$image',
  ...
  print('The response body in sign in with apple is ${response.body}');
