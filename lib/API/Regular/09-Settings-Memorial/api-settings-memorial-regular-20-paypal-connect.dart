...
Future<bool> apiRegularMemorialPaypalConnect({required String userId, required String name, required String email, required int memorialId}) async{
  ...
  // var response = await dioRequest.post('http://fbp.dev1.koda.ws/api/v1/payments/braintree?paypal_user_id=$userId&paypalable_id=$memorialId&paypalable_type=Memorial&name=$name&email=$email',
