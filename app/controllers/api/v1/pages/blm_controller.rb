class Api::V1::Pages::BlmController < ApplicationController
    ...
    def leaveBLM        # leave blm page for family and friends
        return render json: {message: 'Creator cannot leave memorial'}, status: 404 unless @blm.relationships.where(account: user()).first != nil
    ...
    def blm_details_params
        params.permit(:name, :description, :location, :rip, :state, :country, :longitude, :latitude, :qrCode)
    end
