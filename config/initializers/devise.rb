...
Devise.setup do |config|
  ...
  Rails.application.credentials.dig(:facebook, :facebook_app_secret), scope: 'public_profile,email'
  
  config.omniauth :google_oauth2, Rails.application.credentials.dig(:google, :google_app_id),
  Rails.application.credentials.dig(:google, :google_app_secret), scope: 'userinfo.email,userinfo.profile'
