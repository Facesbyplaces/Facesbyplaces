...
class MiscPhoneNumberTemplate extends StatefulWidget{
  ...
  const MiscPhoneNumberTemplate({
    Key? key,
    this.labelText = '',
    this.labelTextStyle = const TextStyle(fontSize: 24, fontFamily: 'NexaRegular', color: Color(0xffBDC3C7),),
  ...
  Widget build(BuildContext context){
    return InputDecorator(
      decoration: const InputDecoration(
        ...
        labelStyle: TextStyle(fontSize: 22, fontFamily: 'NexaRegular', color: Color(0xffBDC3C7),),
        focusedBorder: UnderlineInputBorder(borderSide: BorderSide(color: Color(0xff000000),),),
      ),
      child: DropdownButtonHideUnderline(
        child: DropdownButton<String>(
