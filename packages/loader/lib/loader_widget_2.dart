...
class CustomLoaderThreeDots extends StatefulWidget{
  const CustomLoaderThreeDots({Key? key}) : super(key: key);

  @override
  CustomLoaderThreeDotsState createState() => CustomLoaderThreeDotsState();
}

class CustomLoaderThreeDotsState extends State<CustomLoaderThreeDots> with SingleTickerProviderStateMixin{
