...
class CustomLoaderState extends State<CustomLoader> with TickerProviderStateMixin{
  ...
  void initState() {
    ...
    final tweenSequence = TweenSequence<double>([
      ...
      TweenSequenceItem(tween: Tween<double>(begin: 0.0, end: 180.0).chain(CurveTween(curve: Curves.easeIn)), weight: 15.0),
  ...
  Widget _cube(int i, {required Animation<double> animation}){
    final _size = size * 0.5, _position = size * .5;
          ...
          child: Transform(
            ...
            child: Opacity(
              ...
              child: SizedBox.fromSize(
                ...
                child: Image.asset('assets/icons/cover-icon.png', fit: BoxFit.cover,),
              ),
            ),
          ),
        ),
